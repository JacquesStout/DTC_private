...
for subj in subjects:
    ...
    subj_val_base[subj] = get_group(subj_J, excel_path, subj_column = 'RUNNO', group_column = 'Genotype_group')
...
for stat_type in stat_types:
    ...
    stats_folder_results = '/Users/jas/jacques/Jasien/ANOVA_results'
