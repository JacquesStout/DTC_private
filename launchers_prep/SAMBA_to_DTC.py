...
import os
import shutil
from file_manager.file_tools import buildlink, mkcdir, getfromfile
import glob
import numpy as np
import warnings
from nifti_handlers.atlas_handlers.create_backported_labels import create_backport_labels
import os
import getpass
from file_manager.computer_nav import get_mainpaths, checkfile_exists_remote
...
if remote:
    sftp.close()
# bash_label_maker = "/Volumes/Data/Badea/Lab/mouse/nifti_handlers.atlas_handlers.create_backported_labels_for_fiber_looper.bash"
