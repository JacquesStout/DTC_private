...
trkpath = '/Users/jas/jacques/APOE_trks_test/N58784_wholebrain_all_stepsize_2_gmseed_det_binary_heavytractogram.trk'
anat_path = '/Volumes/Data/Badea/Lab/APOE/DWI_allsubj_RAS/N58784_whitematter.nii.gz'
streamlines = load_trk_remote(trkpath,'same').streamlines
lut_cmap = None
coloring_vals = None
colorbar = None
record_path = '/Users/jas/jacques/APOE_trks_test/quick_test.png'
scene = None
plane = 'all'
interactive=True

scene = setup_view(streamlines[0:1000], colors=lut_cmap, ref=anat_path, world_coords=True, objectvals=coloring_vals,
...
if distance==3:
    figures_path = os.path.join(mainpath, f'Figures_{space_param}{inclusive_str}{symmetric_str}{folder_ratio_str}')
else:
    figures_path = os.path.join(mainpath, f'Figures_distance_{str(distance)}{space_param}{inclusive_str}{symmetric_str}{folder_ratio_str}')
