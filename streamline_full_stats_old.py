...
stats_folder = os.path.join(mainpath, f'Statistics_allregions{space_param}{inclusive_str}{symmetric_str}{folder_ratio_str}',f'stats_allstreams_min{str(min_ref)}')
...
for target_tuple in target_tuples:
    ...
    if make_stats and (not os.path.exists(streamlinestats_path) or overwrite):
        ...
        for ref in references:
            elements = elements + [f'Mean {ref}',f'STD {ref}',f'Median {ref}',f'Statistic {ref}',f'P-value {ref}']
