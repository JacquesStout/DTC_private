...
for target_tuple in target_tuples:
    ...
    for group in groups:
        ...
        bun_num = 0
        if coloring == 'bundles_fa_coloring':
            bundles_fa = []
            bundles_fa_mean = []
        ...
        elif coloring == 'bundles_id_coloring':
            bundles_fa = []
            bundles_fa_mean = []
            for bundle in selected_bundles:
                bundle_fa = []
                ...
                bundles_fa.append(bundle_fa)
                bundles_fa_mean.append(np.mean(bundle_fa))
        elif coloring == 'stream_fa_coloring':
            bundles_fa = []
            bundles_fa_mean = []
            for bundle in selected_bundles:
                bundle_fa = []
        ...
        scene = setup_view(selected_bundles, colors = lut_cmap,ref = anat_path, world_coords = True, objectvals = coloring_vals, colorbar=True, record = record_path, scene = scene, plane = plane, interactive = interactive)
