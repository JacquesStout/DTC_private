...
import warnings
from file_manager.computer_nav import pickledump_remote, remote_pickle
...
kernelsave_path = os.path.join(mainpath, f'kernel.py')
...
coloring_options = ['coherence_coloring_streams','coherence_coloring_points']
...
coloring = 'coherence_coloring_streams'
        ...
        for coloring in coloring_options:
            ...
            if coloring == 'coherence_coloring_points':
                ...
                for bundle in selected_bundles:
                    ...
                    bundle_clrs_points = []
                    for stream_colors in clrs_orig:
                ...
                for bundle in selected_bundles:
                    ...
                    fbc_bundles.append(nib.streamlines.ArraySequence(fbc_sl_orig))
                    templist=[]
                    templist.extend(np.mean(rfbc_orig) for i in range(len(bundle)))
