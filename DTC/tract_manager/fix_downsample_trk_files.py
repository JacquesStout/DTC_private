...
TRK_folder = os.path.join(path,'TRK_MPCA_neworient/')
TRK_output = os.path.join(path,'TRK_MPCA_neworient_fixed/')
...
new_trk_folder = os.path.join(path,'TRK_MPCA_neworient_fixed_100/')
