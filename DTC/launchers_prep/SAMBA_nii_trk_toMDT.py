...
import os
import shutil
from file_manager.file_tools import buildlink
import glob
import numpy as np
import warnings
from nifti_handlers.atlas_handlers.create_backported_labels import create_backport_labels, convert_images_templatespace
import os
import getpass
...
for subject in subjects:
    ...
    convert_images_templatespace(subject, SAMBA_mainpath, SAMBA_projectname, subject_input, orient_string,recenter=recenter)
