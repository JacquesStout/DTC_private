...
AD_Decode_path = '/Users/jas/jacques/AD_Decode_warp_test/'
...
if project == "AD_Decode":
    ...
    ref = "md"
    path_trk_tempdir = os.path.join(AD_Decode_path, 'TRK_save_moving')
    DWI_save = os.path.join(AD_Decode_path, 'NII_save_moving')
