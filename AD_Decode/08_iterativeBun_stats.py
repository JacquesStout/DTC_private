...
for subject in full_subjects_list:
    ...
    for side in sides:
        for new_bundle_id in new_bundle_ids:
            ...
            stat_path_subject = os.path.join(stat_folder, f'{subject}_{side}_bundle_{full_bundle_id}.xlsx')
            ...
            bundle_data_dic[side, new_bundle_id] = bundle_data
            ...
            print(f'Wrote file for subject {subject}, side {side} and {full_bundle_id}')
