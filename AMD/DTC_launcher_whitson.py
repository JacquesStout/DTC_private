...
if subject_processes>1:
    ...
    #dwi_results = pool.starmap_async(diff_handlers.diff_preprocessing, [(dwipath, dwipath_preprocessed, subject, bvec_orient, denoise, savefa, function_processes,
    ...
    for subject in l:
       #dwi_results.append(diff_handlers.diff_preprocessing(dwipath, dwipath_preprocessed, subject, bvec_orient, denoise, savefa,
