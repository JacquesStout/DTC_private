...
if remote:
    ...
    BRUKER_f = '/mnt/paros_WORK/daniel/project/BRUKER_organized_JS/'
else:
    BRUKER_f = '/Users/jas/jacques/Daniel_test/BRUKER_organized_JS/'
    sftp = None
...
for folder in processed_folders:
    ...
    if remote:
        bonus_file_path = os.path.join(bonus_rare_folder, f'sub-{id}_ses-1_T1w.nii.gz')
        copy_loctoremote(rare_path, bonus_file_path, sftp)
