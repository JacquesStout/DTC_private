...
subjects = ['ADRC0113','ADRC0116','ADRC0117','ADRC0118','ADRC0119','ADRC0123','ADRC0127','ADRC0129','ADRC0130','ADRC0134','ADRC0136','ADRC0139','ADRC0147']
subjects = subjects[-5:]
#subjects = ['ADRC0001']
...
for subj in subjects:
    ...
    if not os.path.exists(resampled_mif_path) or not os.path.exists(dwi_nii_gz) or not os.path.exists(mask_nii_path) \
